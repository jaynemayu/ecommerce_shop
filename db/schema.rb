...
ActiveRecord::Schema[7.1].define(version: 2024_07_29_142059) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.index ["updater_id"], name: "index_products_on_updater_id"
  end
  ...
  add_foreign_key "products", "users", column: "updater_id"
